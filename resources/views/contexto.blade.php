...
<head>
  ...
  <title>Accede a Encuesta de contexto</title>
...
<body>
      ...
      <div class="col-lg-8">
        <div class="card p-5">
          <div class="text-center mb-4">
            ...
            <h2>Accede a la encuesta de Contexto
            </h2>
          </div>
        <hr>
          <ol class="fs-5 ps-4">
            ...
            <li>
              Copia tu PASE {{ $registro->usuario->datos['CURP']['valor'] ?? '' }}
  ...
  <script>
    ...
    function abrirVentanaTornelo(e) {
      e.preventDefault();
      const url = 'https://aplicacionesinternas.cecyteg.edu.mx/Evaluaciones/index.php?r=survey/index/sid/438765/lang/es-MX';
