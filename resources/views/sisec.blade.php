...
<body>
      ...
      <div class="col-lg-8">
        ...
        <hr>
          <ol class="fs-5 ps-4">
            ...
            <li>
              Ingresa a:
              <a href="https://certificados.cecyte.edu.mx/Login"
            ...
            <li>
              ...
              y pégala donde dice <b>"Contraseña"</b>.
              ...
              <hr>
              <h2>CURP</h2>
              <h3>{{ $registro->usuario->datos['CURP']['valor'] ?? '' }}</h3>
  ...
  <script>
    ...
    function abrirVentanaBebras(e) {
      e.preventDefault();
      const url = 'https://certificados.cecyte.edu.mx/Login';
